...
const AddPatient: React.FC = () => {
  ...
  const referPatientHandler = (values: any) => {
    const formattedValues = {
      ...values,
      referback: values.referback === "1" // Convert "1" to true, "0" to false
    };
    patientMutate.mutate(formattedValues);
  };
      ...
      >
        {({ values }) => (
          <Form>
            ...
            <button type='submit' className='btn btn-outline-primary'>xferral</button>
          </Form>
        )}
      </Formik>
    </div>
